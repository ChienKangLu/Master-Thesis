...
class Trip_v3 {
    constructor(start_id, destination_id, start_time, end_time, depth, s_attr, s_dis, s_travel, considerMustVisit_order, considerMustNotVist, mustVisit_order, mustNotVist, callback) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Tool_1.default.expmsg(`depth:${this.depth}`);
            let start_time = new Time_1.default(this.start_time);
            let end_time = new Time_1.default(this.end_time);
            let orderIndex = userSetting.attribution;
    ...
    data() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let poi of pois) {
                ...
                let now = new POI_1.default(poi.name, poi.rating, poi._id.toString(), poi.lat, poi.lng, poi.stay_time, weekTime, poi.introduction);
    ...
    setting(start_id, destination_id, start_time, end_time, depth, orderIndex, expSetting) {
        let request = {
