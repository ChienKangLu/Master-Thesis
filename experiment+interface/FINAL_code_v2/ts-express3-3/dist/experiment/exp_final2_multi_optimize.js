...
class exp_final2_multi_optimize {
    constructor() {
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            let run_start = new Date;
            let DBname = "exp_final2_multi_optimize";
            let expSettings = [
                {
                    DBname: DBname,
                    expName: "a4+d5",
            ...
            let minDepth = 2;
            let maxDepth = 4;
            for (let expSettingIndex = 3; expSettingIndex <= 4; expSettingIndex++) {
...
let expAsync = new exp_final2_multi_optimize();
expAsync.run();
