...
class exp_final {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let expSettings = [
                {
                    ...
                    openlist_comparator: "comparater_heap_normal_sigmoid",
                    km15: false,
                    nodeLimitNumber: 0,
                ...
                },
                {
                    DBname: DBname,
                    expName: "t+h+prune",
                    attribution: [Node_1.default.index_travelTime],
                    attraction_heuristic: false,
                    distance_heuristic: false,
                    travelTime_heuristic: false,
                    edgeExcept_heuristic: false,
            ...
            let minDepth = 2;
            let maxDepth = 7;
            for (let expSettingIndex = 0; expSettingIndex <= 7; expSettingIndex++) {
