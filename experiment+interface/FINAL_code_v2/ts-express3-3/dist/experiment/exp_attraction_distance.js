...
class exp_attraction_distance {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let expSettings = [
                {
                    DBname: "exp_attraction_distance_50_sigmoid",
                    expName: "exp_expectation-heuristic-weekTime-reasonable",
                    attribution: [Node_1.default.index_attraction],
                ...
                {
                    DBname: "exp_attraction_distance_50_sigmoid",
                    expName: "exp_distance-heuristic-weekTime-reasonable",
                    attribution: [Node_1.default.index_distance],
                ...
                {
                    DBname: "exp_attraction_distance_50_sigmoid",
                    expName: "exp_expectation-heuristic-distance-heuristic-weekTime-reasonable",
                    attribution: [Node_1.default.index_attraction, Node_1.default.index_distance],
                    attraction_heuristic: true,
                    attraction_expect_type: "attraction_expect_square",
                    dataStructure: "minheap",
                    openlist_comparator: "comparater_heap_sigmoid",
                    km15: false,
                    nodeLimitNumber: 0,
                    considerWeekTime: true,
                    considerReasonable: true,
    ...
    getTestDataNames() {
        return __awaiter(this, void 0, void 0, function* () {
            let db = yield DBAsync_1.DBAsync.connectDBAsync("experiment_1000");
            let coll = yield DBAsync_1.DBAsync.coll(db, "testDataNames");
