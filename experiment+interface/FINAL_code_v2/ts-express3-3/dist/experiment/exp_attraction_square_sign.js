...
class exp_attraction_square_sign {
    constructor() {
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let expSettings = [
                {
                    DBname: "exp_attraction_square_sign_50",
                    expName: "exp_expectation-heuristic-square",
                ...
                {
                    DBname: "exp_attraction_square_sign_50",
                    expName: "exp_expectation-heuristic-square-weekTime-reasonable",
                    attribution: [Node_1.default.index_attraction],
                    attraction_heuristic: true,
                    attraction_expect_type: "attraction_expect_square",
                    dataStructure: "minheap",
                ...
                {
                    DBname: "exp_attraction_square_sign_50",
                    expName: "exp_expectation-heuristic-square-sign",
                    attribution: [Node_1.default.index_attraction],
                    attraction_heuristic: true,
                    attraction_expect_type: "attraction_expect_square_sign",
                    dataStructure: "minheap",
                    openlist_comparator: "comparator_heap",
                    km15: false,
                    nodeLimitNumber: 0,
                ...
                {
                    DBname: "exp_attraction_square_sign_50",
                    expName: "exp_expectation-heuristic-square-sign-weekTime-reasonable",
                    attribution: [Node_1.default.index_attraction],
                    attraction_heuristic: true,
                    attraction_expect_type: "attraction_expect_square_sign",
                    dataStructure: "minheap",
            ...
            let minDepth = 2;
            let maxDepth = 7;
            for (let expSettingIndex = 0; expSettingIndex <= 3; expSettingIndex++) {
...
let expAsync = new exp_attraction_square_sign();
expAsync.run();
