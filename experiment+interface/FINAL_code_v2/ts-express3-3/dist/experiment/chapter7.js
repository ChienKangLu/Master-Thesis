...
class chapter7 {
            ...
            let expSettings = [
                {
                    ...
                    attribution: [Node_1.default.index_attraction, Node_1.default.index_distance, Node_1.default.index_edgeExcept],
    ...
    data() {
        return __awaiter(this, void 0, void 0, function* () {
            let db = yield DBAsync_1.DBAsync.connectDBAsync("finaldata_except");
            ...
            let pairWises = yield DBAsync_1.DBAsync.find(coll, {}, { from: 1, to: 1, distance: 1, travelTime: 1, lineDistance: 1, lineTravelTime: 1, except: 1 });
            let pairWises_num = 0;
            for (let pairWise of pairWises) {
                POImap_1.default.insertPairEdge(pairWise.from, pairWise.to, pairWise.distance, pairWise.travelTime, pairWise.lineDistance, pairWise.lineTravelTime, pairWise.except);
                pairWises_num++;
            }
