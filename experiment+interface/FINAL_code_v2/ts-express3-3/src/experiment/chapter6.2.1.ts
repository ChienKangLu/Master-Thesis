...
class chapter6_2_1 {
    ...
    async run(){
        ...
        let DBname : string = "chapter6_2_1_test";
        let expSettings:Array<expSetting>=[
            {//0
                DBname:DBname,
                expName:"d+prune+h(8am,8pm)",
            ...
            {//2
                DBname:DBname,
                expName:"a4+d10+prune+h(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
            ...
            {//3
                DBname:DBname,
                expName:"a4+d20+prune+h(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
            ...
            {//5
                DBname:DBname,
                expName:"a4.5+d20+prune+h(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
        ...
        let minDepth = 5;//2
        let maxDepth = 5;//5
        for(let expSettingIndex =1;expSettingIndex<=1;expSettingIndex++){
