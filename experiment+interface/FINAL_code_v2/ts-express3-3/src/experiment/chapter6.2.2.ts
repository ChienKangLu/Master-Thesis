...
class chapter6_2_2 {
    ...
    async run(){
        ...
        let DBname : string = "chapter6_2_2_Limit5mins";
        let expSettings:Array<expSetting>=[
            {//0 (2~7 depth)
                DBname:DBname,
                expName:"a4+d5(8am,8pm)",
    ...
    setting(start_id:string,destination_id:string,start_time:Time,
        ...
        constraint.timer=true;
        request.exp_wait = 5*60*1000;
