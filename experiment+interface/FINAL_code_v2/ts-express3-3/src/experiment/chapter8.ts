...
class chapter5 {
    ...
    async run(){
        ...
        let DBname : string = "chapter8";
        let expSettings:Array<expSetting>=[
            {//0
                DBname:DBname,
                expName:"a4+d5+prune+h+tuning0.05(8am,8pm)",
            ...
            {//1
                DBname:DBname,
                expName:"a4+d10+prune+h+tuning0.05(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
            ...
            {//2
                DBname:DBname,
                expName:"a4+d20+prune+h+tuning0.05(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
            ...
            {//3
                DBname:DBname,
                expName:"a3.5+d20+prune+h+tuning0.05(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
            ...
            {//4
                DBname:DBname,
                expName:"a4.5+d20+prune+h+tuning0.05(8am,8pm)",
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                distance_heuristic:true,
                travelTime_heuristic:false,
        ...
        let minDepth = 2;//2
        let maxDepth = 7;//5
        for(let expSettingIndex =0;expSettingIndex<=4;expSettingIndex++){
            let testDataNames:testDataNames = await this.getTestDataNames();
            let random_times = testDataNames.length;
            random_times = 100;//just for small amount data test
    ...
    setting(start_id:string,destination_id:string,start_time:Time,
        ...
        if(expSetting.tuning){
            constraint.tuning = true;
            request.r = expSetting.r;
        }
