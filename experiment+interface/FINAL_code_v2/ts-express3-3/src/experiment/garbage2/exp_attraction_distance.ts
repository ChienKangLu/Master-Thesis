...
class exp_attraction_distance {
    ...
    async run(){
        ...
        let expSettings:Array<expSetting>=[
            {//0
                DBname:"exp_attraction_distance_50_sigmoid",//exp_attraction_distance_50
                expName:"exp_expectation-heuristic-weekTime-reasonable",//exp_expectation-heuristic-weekTime-reasonable
            ...
            {//1
                DBname:"exp_attraction_distance_50_sigmoid",//exp_attraction_distance_50
                expName:"exp_distance-heuristic-weekTime-reasonable",//exp_distance-heuristic-weekTime-reasonable
            ...
            {//2
                DBname:"exp_attraction_distance_50_sigmoid",//exp_attraction_distance_50
                expName:"exp_expectation-heuristic-distance-heuristic-weekTime-reasonable",//exp_expectation-heuristic-distance-heuristic-weekTime-reasonable
                attribution:[Node.index_attraction,Node.index_distance],
                attraction_heuristic:true,
                attraction_expect_type:"attraction_expect_square",
                dataStructure:"minheap",
                openlist_comparator:"comparater_heap_sigmoid",//"comparator_heap_normalize_gaussian"
                km15:false,
                nodeLimitNumber:0,//2000
                considerWeekTime:true,
                considerReasonable:true,
        ...
        */
        let minDepth = 2;//2
        let maxDepth = 7;//5
        for(let expSettingIndex =2;expSettingIndex<=2;expSettingIndex++){
...
let expAsync=new exp_attraction_distance();
expAsync.run();